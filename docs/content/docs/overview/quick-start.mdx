...
For production, publish the image to your own GHCR repository with GitHub Actions, then let the production Compose file pull and run it. See [Publish and Deploy Your Own Docker Image](/docs/overview/docker) for the complete workflow.
