export default {
    ...
    settingsPanels: {
        ...
        model: { select: "Select model", assign: "Assign a model for {{capability}} in the provider settings", noMatch: "No matching {{capability}} models", addFirst: "Configure the provider and refresh its model catalog first", unavailable: "{{model}} (currently unavailable)", capabilities: { image: "image generation", video: "video", text: "text", audio: "audio" }, groups: { gemini: "Gemini series", gptImage: "GPT Image series", grok: "Grok video", sora: "Sora series", veo: "Veo series", omni: "Omni series", feimiaoV2: "feimiao-v2", feimiao431: "feimiao-v2-431", feimiao25: "feimiao-v2.5", openai: "OpenAI", anthropic: "Claude", google: "Gemini language models", deepseek: "DeepSeek", glm: "GLM", grokText: "Grok language models", qwen: "Qwen", other: "Other models" } },
    },
