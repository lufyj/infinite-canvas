export default {
    ...
    settingsPanels: {
        ...
        model: { select: "Select model", assign: "Assign a model for {{capability}} in the provider settings", noMatch: "No matching {{capability}} models", addFirst: "Configure the provider and refresh its model catalog first", unavailable: "{{model}} (currently unavailable)", capabilities: { image: "image generation", video: "video", text: "text", audio: "audio" }, groups: { gemini: "Gemini series", gptImage: "GPT Image series", grok: "Grok video", sora: "Sora series", veo: "Veo series", omni: "Omni series", minimax: "Minimax series", md: "MD group", feimiao20Card: "2.0 card group", feimiao20NoCard: "2.0 non-card group", feimiao25: "2.5 group", ss: "SS series", openai: "OpenAI", anthropic: "Claude", google: "Gemini language models", deepseek: "DeepSeek", glm: "GLM", grokText: "Grok language models", qwen: "Qwen", other: "Other models" } },
    },
    ...
    config: {
        ...
        channels: {
            description: "The app uses the default FMGO provider only. Its catalog controls all available models; plugin metadata supplies image and video parameters.",
            add: "Add provider",
        ...
        channelEditor: {
            title: "Configure FMGO",
            name: "Provider name",
            protocol: "Protocol",
            baseUrl: "API endpoint",
            models: "Provider models",
            modelDescription: "The provider currently exposes {{count}} supported models, grouped automatically by capability.",
            refreshModels: "Refresh models",
            refreshed: "Loaded {{count}} models from the provider",
            lastUpdated: "Last successful refresh: {{time}}",
            notSynced: "The model catalog has not been refreshed successfully",
            catalogError: "Model catalog refresh failed: {{error}}",
            selectModels: "Select models",
            scriptReady: "Script set",
            script: "Request script",
            empty: "The provider has not returned any available models.",
            capabilities: {
                image: "Image",
                video: "Video",
                text: "Text",
        ...
        modelSelect: {
            ...
            title: "Select text and audio models",
            ...
            fetchedEmpty: "No text or audio models match the search.",
