export default {
    ...
    settingsPanels: {
        ...
        model: { select: "选择模型", assign: "请先在渠道里为{{capability}}指定模型", noMatch: "暂无匹配的{{capability}}模型", addFirst: "请先配置渠道并刷新模型目录", unavailable: "{{model}}（当前不可用）", capabilities: { image: "生图", video: "视频", text: "文本", audio: "音频" }, groups: { gemini: "Gemini 系列", gptImage: "GPT Image 系列", grok: "Grok 视频", sora: "Sora 系列", veo: "Veo 系列", omni: "Omni 系列", minimax: "Minimax 系列", md: "md分组", feimiao20Card: "2.0卡分组", feimiao20NoCard: "2.0不卡分组", feimiao25: "2.5分组", ss: "冲啊", openai: "OpenAI", anthropic: "Claude", google: "Gemini 语言模型", deepseek: "DeepSeek", glm: "GLM", grokText: "Grok 语言模型", qwen: "通义千问", other: "其他模型" } },
    },
